...
namespace Looper
{
    internal class ModConfig
    {
        ...
        public static ConfigEntry<int> stagePortalNum;
        public static ConfigEntry<int> stagePortalType;
        ...
        public static void InitConfig(ConfigFile config)
        {
            ...
            stagePortalNum = config.Bind("Stage Portals", "Stage Number", 0, new ConfigDescription("Sets which stage a portal should constantly spawn (pre and post loop) (Vanilla: 0, All: 12345)"));
            stagePortalType = config.Bind("Stage Portals", "Portal Type", 0, new ConfigDescription("Sets which portal should spawn at the end of the selected stage (Bazaar: 0, Gold: 1, Celestial: 2)"));
        }
    }
}
